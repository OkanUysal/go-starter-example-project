        ...
        "/ws": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Room ID to join (use 'lobby' for public lobby)",
                        "name": "room_id",
                        "in": "query",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/websocket.InviteRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/websocket.CreateRoomRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ws/rooms/{room_id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Cannot close lobby",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
